								...
								<table width="452" height="290" border="0" cellpadding="0" cellspacing="0">
									...
									<tr>
										<td align="center" valign="bottom" background="${pageContext.request.contextPath}/images/loginbg.gif">
											<s:form name="form1" action="login" target="_parent" method="post">
												<table border="0" align="center" cellpadding="2" cellspacing="0">
													...
													<tr>
														...
														<td>
															<s:textfield  name="logonPwd" id="logonPwd" cssClass="text" cssStyle="width: 160px;"/>
														</td>
													</tr>
													<tr>
													...
													<tr>
														...
														<td>
															...
															<s:submit  value="重置" cssClass="buttoninput"/>
